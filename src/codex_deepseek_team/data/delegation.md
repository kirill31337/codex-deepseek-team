...
- Fall back to coordinator work after a completed runner error, unavailable credentials/runner, or `DEEPSEEK_TEAM_DISABLED=1` (`CODEX_DEEPSEEK_DISABLED=1` remains supported); do not repeatedly call a broken provider.
